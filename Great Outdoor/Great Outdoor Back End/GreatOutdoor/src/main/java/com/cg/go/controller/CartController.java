...
public class CartController {
	...
	@PutMapping("/updateCart")
     public ResponseEntity<CartItemModel> updateCart( @RequestBody CartItemModel model) throws CartException{
	...
	public ResponseEntity<String> deleteCartItem(@PathVariable("productId") String productId,@PathVariable("userId") String userId) throws CartException{
